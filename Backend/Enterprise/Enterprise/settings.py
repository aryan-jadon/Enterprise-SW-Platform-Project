...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',  # django whitenoise settings
]
...
AWS_ACCESS_KEY_ID = config('AWS_S3_BUCKET_ACCESS_ID')
AWS_SECRET_ACCESS_KEY = config('AWS_S3_BUCKET_ACCESS_KEY')
